  ...
  return (
    <div className="w-full bg-[#F6F6F6] text-[#212121] flex flex-col">
      ...
      <nav className="w-full sticky top-0 bg-[#F6F6F6]/80 backdrop-blur-xl z-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-black tracking-tighter">AroundU</span>
          </div>
          ...
          <button
            onClick={onLogin}
            className="bg-[#093E28] text-white px-5 py-2.5 rounded-full font-bold text-sm hover:opacity-90 transition-opacity active:scale-95"
          >
            Explore Network
          </button>
        </div>
      ...
      <header className="w-full bg-gradient-to-b from-[#E7EDE4] to-[#F6F6F6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-32 grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            <h1 className="text-5xl sm:text-7xl font-black tracking-tighter text-slate-900 leading-tight mb-6">
              Access Everything, <span className="hero-gradient-text">Locally.</span>
            </h1>
            <p className="max-w-md mx-auto md:mx-0 text-lg text-slate-600 mb-10">
            ...
            <div className="flex justify-center md:justify-start gap-4">
              <button
                onClick={onLogin}
                className="bg-[#FF7A59] text-white px-8 py-4 rounded-full font-bold text-lg hover:opacity-90 transition-opacity active:scale-95 shadow-lg shadow-orange-200 flex items-center gap-2"
              >
          ...
          <div className="hidden md:flex items-center justify-center">
             <div className="relative w-[450px] h-[450px]">
                ...
                <div className="absolute w-72 h-40 bg-white rounded-3xl soft-shadow top-1/4 left-0 p-4 transform -rotate-12 transition-all hover:rotate-[-15deg] hover:scale-105">
                  <p className="text-xs font-bold text-slate-400">Now Renting</p>
                  <p className="text-lg font-bold text-slate-800 mt-2">Professional Camera</p>
                  <div className="flex items-center gap-2 mt-4">
                     <img src="https://picsum.photos/seed/alex/40" className="w-8 h-8 rounded-full" alt="user"/>
                     <span className="text-sm font-semibold text-slate-600">from R G</span>
                  </div>
                </div>
                <div className="absolute w-64 h-32 bg-white rounded-3xl soft-shadow bottom-1/4 right-0 p-4 transform rotate-12 transition-all hover:rotate-[15deg] hover:scale-105">
                  <p className="text-xs font-bold text-slate-400">New Listing</p>
                  <p className="text-lg font-bold text-slate-800 mt-2">Camping Tent</p>
      ...
      <section id="features" className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-4xl font-bold tracking-tighter mb-4">A Safer Way to Share</h2>
          <p className="text-slate-600 text-lg max-w-2xl mx-auto mb-16">Our trust-first system ensures every transaction is secure, transparent, and simple.</p>
      ...
      {/* Categories Section */}
      <section id="categories" className="py-20 sm:py-28 bg-[#E7EDE4]/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-4xl font-bold tracking-tighter text-center mb-16">Explore the Neighborhood Inventory</h2>
      ...
      <section id="trust" className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
           <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold tracking-tighter mb-4">Built on a Foundation of Trust</h2>
            <p className="text-slate-600 text-lg mb-16">Hear from members of the AroundU network who are building a more resourceful community.</p>
