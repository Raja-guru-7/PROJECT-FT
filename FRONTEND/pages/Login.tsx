...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  // ── Step 1: Verify email + password → backend sends OTP to email ─────────
  ...
  const inputClass =
    "w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 font-medium text-sm outline-none focus:border-slate-400 transition-all placeholder-slate-400";
          ...
          >
            <div style={{ transform: "translateZ(20px)", backfaceVisibility: "hidden" }}>
              ...
              <div className="text-center mb-8">
                <Link
                  to="/"
                  className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-5 bg-slate-50 border border-slate-200 shadow-sm hover:scale-105 transition-transform"
                >
                ...
                <div className="text-slate-500 text-sm font-medium">
                  {isSuccess
                    ...
                    : showOtp
                      ? <>OTP sent to <span className="font-bold text-slate-800">{formData.email}</span></>
              ...
              {isSuccess ? (
                ...
                >
                  ...
                  <p className="text-slate-800 font-black text-lg tracking-widest uppercase">
                    Connection Secured
                  </p>
                </motion.div>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="anti-pink-btn w-full py-3.5 rounded-xl font-black text-sm uppercase tracking-widest flex items-center justify-center gap-2 mt-2"
                  >
                    {isLoading
                  ...
                  <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center">
                      <span className="px-3 text-xs font-semibold text-slate-400 uppercase tracking-widest bg-white">or</span>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-white border border-slate-200 text-slate-700 text-sm font-bold transition-all hover:bg-slate-50 disabled:opacity-50"
                  >
                    {isGoogleLoading
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={isVerifying}
                    className="anti-pink-btn w-full py-3.5 rounded-xl font-black text-sm uppercase tracking-widest flex items-center justify-center gap-2"
                  >
                    {isVerifying
                      ? <Loader2 className="animate-spin" size={20} />
                  ...
                  <button
                    ...
                    className="w-full text-slate-400 font-bold text-xs uppercase tracking-wider hover:text-slate-800 transition-colors text-center block pt-2"
                  >
                    ← Go Back
                  </button>
                </form>
